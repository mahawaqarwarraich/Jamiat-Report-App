  ...
  const fetchDays = async () => {
    try {
      ...
      if (response.data && response.data.success) {
        ...
        // Calculate stats for Umeedwar (same as Rukn)
        const totalDays = fetchedDays.length;
        // For Umeedwar, consider a day completed if namaz is yes and at least one other activity is yes
...
export default UmeedwarDashboard;
