  ...
  const fetchDays = async () => {
    try {
      ...
      if (response.data && response.data.success) {
        ...
        const namazDays = fetchedDays.filter(day => day.namaz === 'yes').length;
        const hifzDays = fetchedDays.filter(day => day.hifz === 'yes').length;
        const nazraDays = fetchedDays.filter(day => day.nazra === 'yes').length;
        const tafseerDays = fetchedDays.filter(day => day.tafseer === 'yes').length;
...
export default RafeeqaDashboard;
