...
const UmeedwarDailyReport = () => {
  ...
  const fetchCurrentReport = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`/umeedwar-reports/${selectedMonth}/${selectedYear}`);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post('/umeedwar-reports/add-day', dayData);
      ...
      {selectedDayData && (
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="space-y-6">
            ...
            {/* Religious Activities - Umeedwar Specific */}
            ...
            {/* Numeric Fields - Umeedwar Specific */}
