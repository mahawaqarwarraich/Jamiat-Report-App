          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Darsi Kutab</th>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Amoomi</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Khatoot</th>
      ...
      <div className="mt-6 bg-white rounded-lg shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900">
              {days.reduce((sum, day) => sum + (day.amoomiAfraadMulakaat || 0), 0)}
            </p>
          </div>
          <div>
            <p className="text-sm font-medium text-gray-600">Total Khatoot</p>
            <p className="text-2xl font-bold text-gray-900">
              {days.reduce((sum, day) => sum + (day.khatootTadaad || 0), 0)}
            </p>
          </div>
        </div>
      </div>
...
export default RafeeqaMonthView;
