...
const RafeeqaPDFDownload = () => {
  ...
  const fetchDays = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`/rafeeqa-reports/${selectedMonth}/${selectedYear}/days`);
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `/rafeeqa-reports/${selectedMonth}/${selectedYear}/pdf`,
        { responseType: 'arraybuffer' }
      );
      ...
      const fileName = `rafeeqa-report-${selectedMonth}-${selectedYear}.pdf`;
...
export default RafeeqaPDFDownload;
