    ...
    try {
      ...
      if (!Capacitor.isNativePlatform()) {
        ...
        try {
          ...
          const response = await axios.get(`/umeedwar-reports/${selectedMonth}/${selectedYear}/pdf`, {
          ...
          link.href = url;
          link.download = `umeedwar-report-${selectedMonth}-${selectedYear}.pdf`;
      ...
      const response = await axios.get(
        `/umeedwar-reports/${selectedMonth}/${selectedYear}/pdf`,
        { responseType: 'arraybuffer' }
      );
      ...
      const fileName = `umeedwar-report-${selectedMonth}-${selectedYear}.pdf`;
