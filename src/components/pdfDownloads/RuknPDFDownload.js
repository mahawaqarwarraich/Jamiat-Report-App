...
const RuknPDFDownload = () => {
    ...
    try {
      ...
      if (!Capacitor.isNativePlatform()) {
        ...
        try {
          ...
          const response = await axios.get(`/rukn-reports/${selectedMonth}/${selectedYear}/pdf`, {
          ...
          link.href = url;
          link.download = `rukn-report-${selectedMonth}-${selectedYear}.pdf`;
      ...
      const response = await axios.get(
        `/rukn-reports/${selectedMonth}/${selectedYear}/pdf`,
        { responseType: 'arraybuffer' }
      );
      ...
      const fileName = `rukn-report-${selectedMonth}-${selectedYear}.pdf`;
  ...
  const getCompletionStats = () => {
    ...
    // For Rukn, use namazBarwaqtAdaigi instead of namaz
...
export default RuknPDFDownload;
