...
const RuknMonthView = () => {
  ...
  const getCompletionRate = (day) => {
    // Count all yes/no fields for Rukn
    const ruknFields = [
    ...
    const activities = ruknFields.map(field => day[field] === 'yes');
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900">
              {days.reduce((sum, day) => {
                ...
                return sum + ruknFields.filter(field => day[field] === 'yes').length;
              }, 0)}
            </p>
          </div>
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900">
              {days.filter(day => {
                ...
                return ruknFields.some(field => day[field] === 'yes');
              }).length}
            </p>
          </div>
          <div>
